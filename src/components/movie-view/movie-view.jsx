...
class MovieView extends React.Component {
    ...
    getUser(token) {
        axios.get(`http://cinemadbloadbalancer-1051342674.us-east-1.elb.amazonaws.com:8081/users/${localStorage.getItem('user')}`, {
    ...
    addToFavorites(movie) {
        ...
        axios.post(`http://cinemadbloadbalancer-1051342674.us-east-1.elb.amazonaws.com:8081/users/${user}/FavoriteMovies/${movie._id}`, {},
            {
                headers: {
