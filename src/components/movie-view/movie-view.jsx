...
class MovieView extends React.Component {
    ...
    getUser(token) {
        axios.get(`http://ec2-44-204-142-22.compute-1.amazonaws.com:8081/users/${localStorage.getItem('user')}`, {
    ...
    addToFavorites(movie) {
        ...
        axios.post(`http://ec2-44-204-142-22.compute-1.amazonaws.com:8081/users/${user}/FavoriteMovies/${movie._id}`, {},
            {
                headers: {
