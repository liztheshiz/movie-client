...
export function ProfileView(props) {
    ...
    const deleteUser = () => {
        axios.delete(`http://ec2-44-200-110-9.compute-1.amazonaws.com:8081/users/${props.user.Username}`, {
    ...
    const handleSubmit = (e) => {
        ...
        if (isReq) {
            ...
            axios.put(`http://ec2-44-200-110-9.compute-1.amazonaws.com:8081/users/${props.user.Username}`, request, {
                headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }
            }).then(res => {
                const data = res.data;
                console.log(data);
    ...
    const removeFromFavorites = (movieid) => {
        axios.delete(`http://ec2-44-200-110-9.compute-1.amazonaws.com:8081/users/${props.user.Username}/FavoriteMovies/${movieid}`, {
            headers: { Authorization: `Bearer ${localStorage.getItem('token')}` }
        }).then(res => {
